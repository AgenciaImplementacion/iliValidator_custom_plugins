...
public class CrossesIoxPlugin implements InterlisFunction {
                        ...
                        if (object != null) {
                            ...
                            for (int surfacei = 0; surfacei < surfacec; surfacei++) {
                                ...
                                try {
                                    ...
                                    Logger.getLogger(CrossesIoxPlugin.class.getName()).log(Level.SEVERE, null, ex);
                                }
                            }
                        }
            ...
            if (geomType.equals(MULTI_SURFACE_TYPE)) {
                ...
                for (int i = 0; i < mp.getNumGeometries(); i++) {
                    ...
                    for (int j = i + 1; j < mp.getNumGeometries(); j++) {
                        ...
                        spatialResult |= (geometryA.crosses(geometryB));
                ...
                while (objectIterator.hasNext()) {
                    ...
                    if (iomObj != null) {
                        ...
                        if (iomObj.getobjecttag().equals(currentObjectTag) && !mainObj.equals(iomObj)) {
                            ...
                            spatialResult |= (currentObjectGeometry.crosses(iteratedPolygon));
                        }
                    }
                }
            }
    ...
    public String getQualifiedIliName() {
        return "INTERLIS_TOPOLOGY.crosses";
    }
