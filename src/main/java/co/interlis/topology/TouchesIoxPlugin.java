...
public class TouchesIoxPlugin implements InterlisFunction {
                        ...
                        if (object != null) {
                            ...
                            for (int surfacei = 0; surfacei < surfacec; surfacei++) {
                                ...
                                try {
                                    ...
                                    Logger.getLogger(TouchesIoxPlugin.class.getName()).log(Level.SEVERE, null, ex);
                                }
                            }
                        }
            ...
            if (geomType.equals(MULTI_SURFACE_TYPE)) {
                ...
                for (int i = 0; i < mp.getNumGeometries(); i++) {
                    ...
                    for (int j = i + 1; j < mp.getNumGeometries(); j++) {
                        ...
                        spatialResult |= (geometryA.touches(geometryB));
                ...
                while (objectIterator.hasNext()) {
                    ...
                    if (iomObj != null) {
                        ...
                        if (iomObj.getobjecttag().equals(currentObjectTag) && !mainObj.equals(iomObj)) {
                            ...
                            spatialResult |= (currentObjectGeometry.touches(iteratedPolygon));
                        }
                    }
                }
            }
    ...
    public String getQualifiedIliName() {
        return "INTERLIS_TOPOLOGY.touches";
    }
