...
public class EqualsIoxPlugin implements InterlisFunction {
                        ...
                        if (object != null) {
                            ...
                            for (int surfacei = 0; surfacei < surfacec; surfacei++) {
                                ...
                                try {
                                    ...
                                    Logger.getLogger(EqualsIoxPlugin.class.getName()).log(Level.SEVERE, null, ex);
                                }
                            }
                        }
    ...
    public String getQualifiedIliName() {
        return "INTERLIS_TOPOLOGY.equals";
    }
